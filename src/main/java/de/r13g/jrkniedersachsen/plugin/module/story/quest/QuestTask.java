  ...
  public static class Adapter implements JsonDeserializer<QuestTask> {
    ...
    public QuestTask deserialize(JsonElement e, java.lang.reflect.Type _t, JsonDeserializationContext c) throws JsonParseException {
      ...
      switch (Type.valueOf(t)) {
        case EXTERNAL:
          return c.deserialize(e, ExternalTask.class);
        case DETECT_ITEM:
          return c.deserialize(e, DetectItemTask.class);
        case COLLECT_ITEM:
          return c.deserialize(e, CollectItemTask.class);
        case CRAFT_ITEM:
          return c.deserialize(e, CraftItemTask.class);
        case LOCATION:
          return c.deserialize(e, LocationTask.class);
        case BREAK_BLOCK:
          return c.deserialize(e, BreakBlockTask.class);
        case PLACE_BLOCK:
          return c.deserialize(e, PlaceBlockTask.class);
        case TAME:
          return c.deserialize(e, TameTask.class);
        case KILL:
          return c.deserialize(e, KillTask.class);
      }
