...
import de.r13g.jrkniedersachsen.plugin.module.MorpheusModule;
...
public class AfkModule implements Module, Listener { //TODO: Test
  ...
  public void onPlayerMove(PlayerMoveEvent ev) {
    ...
    if (isAfk.contains(ev.getPlayer().getUniqueId())) {
      ...
      ev.getPlayer().setDisplayName(ev.getPlayer().getDisplayName().replace("" + ChatColor.ITALIC + ChatColor.GRAY + "[A]" + ChatColor.RESET, ""));
